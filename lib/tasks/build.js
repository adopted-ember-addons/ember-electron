...
//
// A task that builds out the Ember app shimmed to run in electron, and
// optionally assembles the app into an electron forge-compatible project.
//
class BuildTask extends Task {
  // platform is only used when assembling
  run({ outputPath, environment, assemble, platform }) {
    let { ui, project } = this;
