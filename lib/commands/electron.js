...
module.exports = {
  ...
  runElectron: function () {
    ...
    return new Promise((resolve, reject) => {
      ...
      const getElectronApp = require('../helpers/find-electron').getElectronApp
      const electronCommand = getElectronApp(project)
      const safeCommand = (electronCommand.includes(' ')) ? safePath(electronCommand) : electronCommand
